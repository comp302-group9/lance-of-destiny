...
public class ClientView extends JPanel {
    ...
    public ClientView() {
        ...
        JLabel leftPlaceholderLabel = new JLabel("Waiting");
        ...
        // Add the status label to the left center panel below the placeholder label
        GridBagConstraints gbcStatusLabel = new GridBagConstraints();
        gbcStatusLabel.gridx = 0;
        gbcStatusLabel.gridy = 1; // Position the status label below the placeholder label
        gbcStatusLabel.anchor = GridBagConstraints.CENTER;
        leftPanelCenter.add(statusLabel, gbcStatusLabel);
        ...
        gbcButton.gridx = 0;
        gbcButton.gridy = 0; // Position the button at the top
        gbcButton.anchor = GridBagConstraints.CENTER;
        rightPanelCenter.add(readyButton, gbcButton);

        // Add a placeholder label to the right center panel below the button
        JLabel rightPlaceholderLabel = new JLabel("Not Ready");
        rightPlaceholderLabel.setForeground(Color.RED); // White text for visibility
        ...
        gbcRightLabel.gridy = 1; // Position the label below the button
