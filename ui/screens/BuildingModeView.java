...
public class BuildingModeView extends JPanel{
    ...
    ImageIcon simpleIcon = new ImageIcon(getClass().getResource("/ui/images/simpleBarrier.png"));
    ImageIcon firmIcon = new ImageIcon(getClass().getResource("/ui/images/reinforcedBarrier.png"));
    ImageIcon redIcon = new ImageIcon(getClass().getResource("/ui/images/explosiveBarrier.png"));
    ImageIcon greenIcon = new ImageIcon(getClass().getResource("/ui/images/rewardingBarrier.png"));
